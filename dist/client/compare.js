...
const $=s=>document.querySelector(s),names={qwen:'Qwen 3.8 · 27B',gemma:'Gemma 4 · 31B',flash:'Gemini 3.8 Flash',astra:'GPT‑6 Astra',luna:'GPT‑5.6 Luna',opus:'Claude Opus 5'},colors={qwen:'#4166c3',gemma:'#bd6e32',flash:'#219678',astra:'#9562b6',luna:'#cf527d',opus:'#6d7b36'},labels={COMPLETE:'已结束',RUNNING:'运行中',STARTING:'启动中',FAILED:'中断（保留结果）'};
